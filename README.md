...
**Launch the notebook:**
```bash
jupyter notebook PDS_OEP.ipynb
```
...
After training, the model is exported as `.pkl` files for standalone inference:
...
# (Apply feature engineering + preprocessing before calling predict)
